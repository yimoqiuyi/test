...
<div class="container" id="top">
 ...
 <form class="form-horizontal" action="${pageContext.request.contextPath}/user/main.do?id=${id}" >
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <img alt="个人照"  style="width:100px"  src="${pageContext.request.contextPath}/picture/<%=user.getPicture()%>">
    </div>
  </div>
     <div class="form-group pull-right" style="margin-right: 40px;">
 	    <div  class="col-sm-offset-2 col-sm-10">
 	   <button type="reset"class="btn btn-default btn-info" style="width:60px"><a href="${pageContext.request.contextPath}/user/select.do?id=<%=user.getId()%>">修改</a></button> 
      </div>
 	  </div>
      <div class="form-group pull-right" style="margin-right: 40px;">
 	    <div  class="col-sm-offset-2 col-sm-10">
