	...
	<div class="container" id="top">
		<div class="row" style="margin-top:280px; ">
			...
			<div class="col-md-4" id="login-box">
				<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/user/login.do" id="from1" >
				  <div class="form-group">
				    <label for="firstname" class="col-sm-3 control-label">用户名:</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="userID" style="width:180px" placeholder="请输入名字" name="name" read>
				    </div>
				  </div>
				  ...
				  <div class="form-group">
 				  ...
 				  <div class="form-group pull-right" style="margin-right: 40px;">
 				   <div  class="col-sm-offset-2 col-sm-10">
 				     <button type="button"class="btn btn-default btn-info" style="width:60px"><a href="/test/user/regist.do">注册  </a></button>
 				    </div>
 				    </div>
				</form>
			</div>   
